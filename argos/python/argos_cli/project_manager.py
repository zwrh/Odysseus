...
"""
Project management for Argos CLI.

Handles creation and management of Ghidra projects in .argos/projects/
...
class ProjectManager:
    """Manages Ghidra project creation and lifecycle for Argos CLI."""
    ...
    def __init__(self, projects_dir: Optional[Path] = None):
        ...
        Args:
            projects_dir: Custom projects directory, defaults to .argos/projects/ in current directory
        """
        if projects_dir is None:
            self.projects_dir = Path.cwd() / ".argos" / "projects"
        else:
    ...
    def _ensure_initialized(self):
        ...
        This implements lazy initialization - the .argos directory and Ghidra project

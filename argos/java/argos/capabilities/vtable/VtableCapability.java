...
package argos.capabilities.vtable;
 ...
 */
public class VtableCapability extends BaseCapability {
    ...
    /**
     * Creates a new VtableCapability.
     * @param server The MCP server to register tools with
     */
    public VtableCapability(McpSyncServer server) {
        super(server);
    }

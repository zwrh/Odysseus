...
package argos.capabilities.dataflow;
...
public class DataFlowCapability extends BaseCapability {
    ...
    private int getDecompilerTimeout() {
        try {
            ...
            if (settings != null) {
                return settings.getDecompilerTimeoutSeconds();
            }
        } catch (Exception e) {

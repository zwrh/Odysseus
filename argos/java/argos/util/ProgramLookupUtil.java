...
import argos.capabilities.ProgramValidationException;

/**
 * Utility class for consistent program lookup across all Argos tools.
...
public class ProgramLookupUtil {
     ...
     * This method first attempts to find the program using ArgosProgramManager,
    ...
    public static Program getValidatedProgram(String programPath) throws ProgramValidationException {
        ...
        Program program = ArgosProgramManager.getProgramByPath(programPath);

 ...
 * <ul>
 *   <li><b>Debug mode</b> ({@link Settings#isDebugMode()}): Logs request headers to Ghidra's log</li>
 *   <li><b>Request logging</b> ({@link Settings#isRequestLoggingEnabled()}): Logs full HTTP
 *       request/response bodies to argos-tools.log for debugging MCP protocol issues</li>
 * </ul>
 */
public class RequestLoggingFilter implements Filter {
     ...
     *
     * @param settings The settings to check logging settings
     */
    public RequestLoggingFilter(Settings settings) {
    ...
    public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain)
        ...
        // Request logging mode: Log full HTTP request/response to argos-tools.log
        if (settings.isRequestLoggingEnabled()) {
    ...
    /**
     * Filter with full request/response body logging to argos-tools.log.
     */
    private void doFilterWithBodyLogging(HttpServletRequest request, HttpServletResponse response,
        ...
        ArgosToolLogger.logHttpRequest(
            requestId,
            request.getMethod(),
        ...
        Msg.debug(this, String.format("[Argos:%s] HTTP %s %s",
        ...
        try {
            ...
            ArgosToolLogger.logHttpResponse(
                requestId,
